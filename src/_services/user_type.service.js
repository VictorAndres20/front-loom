...
const BASE_PATH = '/user-type';

export const findAllUserType = async () => {
    return await handleFetch(`${BASE_PATH}/all`, GET_OPTIONS);
}

export const findUserTypeById = async (id) => {
...
export const editUserType = async (id, body) => {
    return await handleFetch(`${BASE_PATH}/edit/${id}`, PUT_OPTIONS, body);
}

export const findAllUserTypePaged = async (page, limit) => {
